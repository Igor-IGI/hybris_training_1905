...
public class DefaultTrainingsocialsitecoreService implements TrainingsocialsitecoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingsocialsitecoreService.class);
	...
	{
		return DefaultTrainingsocialsitecoreService.class.getResourceAsStream("/trainingsocialsitecore/sap-hybris-platform.png");
	}
