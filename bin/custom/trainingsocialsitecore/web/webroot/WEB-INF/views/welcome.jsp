...
<html>
<head>
    <title>Welcome to trainingsocialsitecore</title>
    <link rel="stylesheet" href="<c:url value="/static/trainingsocialsitecore-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "trainingsocialsitecore" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/trainingsocialsitecore-items.xml</b> - here you can model your items</li>
            <li><b>resources/trainingsocialsitecore-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/trainingsocialsitecore-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/trainingsocialsitecore-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/trainingsocialsitecore-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
