...
public class DefaultTrainingsocialsitefacadeService implements TrainingsocialsitefacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingsocialsitefacadeService.class);
	...
	{
		return DefaultTrainingsocialsitefacadeService.class.getResourceAsStream("/trainingsocialsitefacade/sap-hybris-platform.png");
	}
