...
import de.hybris.platform.testwebservices.cart.impl.CommerceWebServicesCartFacade;
import de.hybris.platform.testwebservices.exceptions.InvalidPaymentInfoException;
import de.hybris.platform.testwebservices.exceptions.NoCheckoutCartException;
import de.hybris.platform.testwebservices.exceptions.UnsupportedDeliveryModeException;
import de.hybris.platform.testwebservices.exceptions.UnsupportedRequestException;
import de.hybris.platform.testwebservices.order.data.CartDataList;
import de.hybris.platform.testwebservices.order.data.OrderEntryDataList;
import de.hybris.platform.testwebservices.product.data.PromotionResultDataList;
import de.hybris.platform.testwebservices.request.support.impl.PaymentProviderRequestSupportedStrategy;
import de.hybris.platform.testwebservices.stock.CommerceStockFacade;
import de.hybris.platform.testwebservices.voucher.data.VoucherDataList;
