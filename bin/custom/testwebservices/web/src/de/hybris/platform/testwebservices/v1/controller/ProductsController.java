...
import de.hybris.platform.testwebservices.formatters.WsDateFormatter;
import de.hybris.platform.testwebservices.product.data.ProductDataList;
import de.hybris.platform.testwebservices.product.data.SuggestionDataList;
import de.hybris.platform.testwebservices.queues.data.ProductExpressUpdateElementData;
import de.hybris.platform.testwebservices.queues.data.ProductExpressUpdateElementDataList;
import de.hybris.platform.testwebservices.queues.impl.ProductExpressUpdateQueue;
import de.hybris.platform.testwebservices.stock.CommerceStockFacade;
import de.hybris.platform.testwebservices.util.ws.SearchQueryCodec;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link de.hybris.platform.testwebservices.populator.HttpRequestReviewDataPopulator} to populate review data
