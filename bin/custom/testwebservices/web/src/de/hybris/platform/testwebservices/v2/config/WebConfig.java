 ...
 */
package de.hybris.platform.testwebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.testwebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "testwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "testwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "testwebservices.oauth2.tokenUrl";

	private static final String DESC = "testwebservices.v2.description";
	private static final String TITLE = "testwebservices.v2.title";
	private static final String VERSION = "testwebservices.v2.version";
	private static final String LICENSE = "testwebservices.v2.license";
	private static final String LICENSE_URL = "testwebservices.v2.license.url";
